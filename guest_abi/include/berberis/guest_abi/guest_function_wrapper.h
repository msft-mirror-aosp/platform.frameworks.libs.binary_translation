...
#ifndef BERBERIS_GUEST_ABI_GUEST_FUNCTION_WRAPPER_H_
#define BERBERIS_GUEST_ABI_GUEST_FUNCTION_WRAPPER_H_
...
#endif  // BERBERIS_GUEST_ABI_GUEST_FUNCTION_WRAPPER_H_
